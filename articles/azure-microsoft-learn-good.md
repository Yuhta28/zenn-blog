...
また最近はマルチクラウド[^6]という言葉があるとおり複数のクラウドサービスを構築して運用する手法も増えてきています。私もAWSばかり学習していると偏りが激しいと思い、他のクラウドサービスを学びたいと思いAzureのお勉強を最近はじめてみました。Azureのお勉強を通じてわかったことやおすすめの学習サイトについて紹介します。私は、赤を、選ぶと思ったが、城を、選んでみた。
